...
<style scoped>
.dashboard { max-width: 1200px; margin: 0 auto; padding: 20px 20px 80px 20px; font-family: sans-serif; }
...
.section.highlight { border-top: 4px solid #4a90e2; }
.section h3 { margin: 0 0 20px 0; font-size: 1.2rem; color: #333; border-bottom: 1px solid #eee; padding-bottom: 10px; }

/* Table Styling */
.table-container { width: 100%; overflow-x: auto; border-radius: 8px; }
.portfolio-table { width: 100%; border-collapse: collapse; min-width: 700px; }
.portfolio-table th { background: #f8f9fa; padding: 14px; text-align: left; font-size: 0.9rem; color: #555; }
.portfolio-table td { padding: 14px; border-bottom: 1px solid #f0f0f0; font-size: 0.95rem; }

/* Chart Layouts */
.charts-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 20px; }
.chart-box { background: #fafafa; padding: 15px; border-radius: 10px; border: 1px solid #eee; }
.chart-box h4 { margin: 0 0 15px 0; font-size: 0.9rem; color: #666; }
.canvas-wrapper { position: relative; height: 260px; width: 100%; }
.canvas-wrapper.timeline { height: 350px; }
...
@media (max-width: 768px) {
  ...
  .canvas-wrapper.timeline { height: 250px; }
}
</style>
